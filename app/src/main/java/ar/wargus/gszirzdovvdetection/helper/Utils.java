...
public class Utils {
	...
	public static Point detect(Line l1, Line l2) {
		if (!intersects(l1, l2)) { return null;	}
		 ...
		 * intersect
		 */
		x1line1 = (double) l1.getP1().x;
		y1line1 = (double) l1.getP1().y;
		x2line1 = (double) l1.getP2().x;
		y2line1 = (double) l1.getP2().y;
		x1line2 = (double) l2.getP1().x;
		y1line2 = (double) l2.getP1().y;
		x2line2 = (double) l2.getP2().x;
		y2line2 = (double) l2.getP2().y;
		 ...
		 */
		if ((x1line1 == x1line2)
			&& (y1line1 == y1line2)) return (new Point((int) x1line1,
		                                               (int) y1line1));
		
		if ((x1line1 == x2line2)
			&& (y1line1 == y2line2)) return (new Point((int) x1line1,
		                                               (int) y1line1));
		
		if ((x2line1 == x1line2)
			&& (y2line1 == y1line2)) return (new Point((int) x2line1,
		                                               (int) y2line1));
		
		if ((x2line1 == x2line2)
			&& (y2line1 == y2line2)) return (new Point((int) x2line1,
		                                               (int) y2line1));
		 ...
		 */
		if ((dyline1 * dxline2
			 - dyline2 * dxline1) == 0) return null;
		
		return new Point((int) (-(e * dxline2
				                  - dxline1 * f)
				                 / (dyline1 * dxline2
						            - dyline2 * dxline1)),
		                 (int) (-(dyline1 * f
	...
	public static boolean intersects(Line l1, Line l2) {
		Point start1    = l1.getP1();
		Point end1      = l1.getP2();
		Point start2    = l2.getP1();
		Point end2      = l2.getP2();
		// First find Ax+By=C values for the two lines
		double A1 = end1.y - start1.y;
		double B1 = start1.x - end1.x;
		double C1 = A1 * start1.x
				    + B1 * start1.y;
		
		double A2 = end2.y - start2.y;
		double B2 = start2.x - end2.x;
		double C2 = A2 * start2.x
				    + B2 * start2.y;
...
//	@Nullable
//	public static Point lineLineIntersection(Line l1, Line l2){
//		Point A = l1.getP1();
//        Point B = l1.getP2();
//        Point C = l2.getP1();
//        Point D = l2.getP2();
...
//
//		if (determinant == 0){
//			// The lines are parallel. So no collision in our case.
//			return null;
//		}
//		else{
...
//	}
	...
	public static Double pointPointDistance(Point p1, Point p2){
		return Math.hypot(p1.x-p2.x,
		                  p1.y-p2.y);
	}
	public static Double pointPointDistance(int x1,
	                                        int y1,
	                                        int x2,
	                                        int y2){
